...
- Each plugin `.plugin-cross-port.json` records plugin-level `source_of_truth`.
...
1. Read `.plugin-cross-port.marketplace.json`
2. Read `<plugin-path>/.plugin-cross-port.json`
