...
- **combined-review** (v1.8.0) — Multi-agent code review + CodeRabbit CLI; GitHub PR + GitLab MR with inline resolvable threads; `/rereview` verifies + resolves + approves; opt-in `security-reviewer`; `/review-config` for language/model/CodeRabbit/security
